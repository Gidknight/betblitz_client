...
const LiveBetting = () => {
  ...
  return (
    <div className="p-3  md:p-5 w-full bg-dark text-white flex flex-col overflow-x-auto">
      <div className="flex flex-row items-center justify-between">
        <div className="flex flex-row items-center justify-start gap-2">
          <span className="p-3 bg-live rounded-full"></span>

          <h1 className="text-lg md:text-2xl font-bold">Live Betting</h1>
        </div>
          ...
          <div className="w-full">
            ...
            {sportType == "Cricket" && (
              <div>
                ...
                <LiveGames leagueName="Nigeria league" />
              </div>
            )}

      ...
      <div className=" flex flex-row items-center justify-evenly w-1/2 gap-1">
        ...
        <div className="flex flex-row">
          <OddButton
            ...
            odd={over9_5}
            customFunction={() =>
              handleClick(over9_5, "Over Under", `Over 141`)
            }
          />
          <OddButton
            isDisabled={status == "FT" ? true : false}
            ...
            odd={under9_5}
            customFunction={() =>
              handleClick(under9_5, "Over Under", `Under 141`)
            }
          />
        </div>
        ...
        <div className="flex flex-row">
          <OddButton
            ...
            odd={over10_5}
            customFunction={() =>
              handleClick(over10_5, "Over Under", `Over 140`)
            }
          />
          <OddButton
            isDisabled={status == "FT" ? true : false}
            ...
            odd={under10_5}
            customFunction={() =>
              handleClick(under10_5, "Over Under", `Under 140`)
            }
          />
        </div>
        ...
        <div className="flex flex-row">
          <OddButton
            ...
            odd={over11_5}
            customFunction={() =>
              handleClick(over11_5, "Over Under", `Over 137`)
            }
          />
          <OddButton
            isDisabled={status == "FT" ? true : false}
            ...
            odd={under11_5}
            customFunction={() =>
              handleClick(under11_5, "Over Under", `Under 137`)
            }
          />
        </div>
...
const Basketball_OverUnder = ({ match, date, sportType }) => {
    ...
    <div className="w-full">
      <div className="flex flex-row items-center justify-evenly w-100 py-2">
        ...
        <div className="w-full flex flex-row items-center justify-around px-2 gap-1">
          ...
          <span className="text-sm text-slate-400 text-center w-full">141</span>
          <span className="text-sm text-slate-400 text-center w-full">140</span>
          <span className="text-sm text-slate-400 text-center w-full">137</span>
          {/* </div> */}
        </div>
      </div>
      <div>
...
export default Basketball_OverUnder;

...
import TopWithBackButton from "./includes/TopWithBackButton";
  ...
  return (
    <>
      ...
      >
        ...
        {/* <div
          id="profile_avatar"
          className="md:px-20 sticky top-0 flex items-center justify-start w-full gap-3 bg-black bg-opacity-10 p-2"
        >
           <Image
            alt="profile picture"
